...
public class RobotPlayer {
    ...
    static void runRatKing(RobotController rc) throws GameActionException {
        ...
        // ARCHETYPE DIFFERENCE (pure_cooperator): never initiates a
        // backstab, so the Iteration 11/12 desperation system is disabled
        // outright rather than merely unused -- a bot that would defect
        // under economic pressure is not a pure cooperator. Everything
        // else (economy, movement, cat engagement) tracks src/bot/.
    ...
    static void runBabyRat(RobotController rc) throws GameActionException {
        ...
        // ARCHETYPE DIFFERENCE: retaliates only once actually backstabbed;
        // never reads the desperation signal (never written, see King).
        boolean desperate = false;
        if (!rc.isCooperation()) {
